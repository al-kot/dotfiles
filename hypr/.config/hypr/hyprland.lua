...
hl.config({
	...
	general = {
		...
		col = {
			active_border = { colors = { "rgba(92837400)" } },
...
local mainMod = "ALT + SUPER + CTRL" -- Sets "Windows" key as main modifier
...
for k, v in next, moves do
	hl.bind(mainMod .. " + " .. v[1], hl.dsp.focus({ direction = k }))
	hl.bind(mainMod .. " + " .. v[2], hl.dsp.focus({ direction = k }))
	hl.bind(mainMod .. " + SHIFT + " .. v[1], hl.dsp.window.move({ direction = k }))
	hl.bind(mainMod .. " + SHIFT + " .. v[2], hl.dsp.window.move({ direction = k }))
end
